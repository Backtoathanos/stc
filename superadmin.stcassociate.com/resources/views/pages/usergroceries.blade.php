  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="{{ url('/users/groceriesusers/create') }}" class="btn btn-block btn-primary btn-md">Create Groceries User</a></div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{url('/users/groceriesusers/delete/'.$value->stc_groceries_user_id)}}" class="btn btn-danger btn-sm" ><i class='fas fa-trash'></i></a>
                                <a href="{{url('/users/groceriesusers/edit/'.$value->stc_groceries_user_id)}}" class="btn btn-danger btn-sm" ><i class='fas fa-edit'></i></a>
                                <?php     

                                  $server = $_SERVER['SERVER_NAME']=="localhost" ? "http://localhost/stc" : "https://stcassociate.com";
                                  $user_id = $value->stc_groceries_user_id;
                                  $user_type = "groceries";
