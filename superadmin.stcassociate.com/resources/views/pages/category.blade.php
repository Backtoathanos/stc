...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="javascript:void(0)" class="btn btn-block btn-primary btn-md" data-target="#add-modal" data-toggle="modal">Add Category</a></div>
  ...
  <script>
    $(document).ready(function() {
      ...
      getCategory(dataTableAct);      
      
      // get category function
      function getCategory(dataTableAct){
          // DataTable
          $('#example1').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('/master/category/list') }}",
          columns: [
              { data: 'stc_cat_id' },
              { data: 'stc_cat_name' },
              { data: 'stc_cat_status' },
      ...
      $('body').delegate('.add-category-btn','click', function(){
        ...
        $.ajax({
            ...
            url: "{{ url('/master/category/create') }}",
