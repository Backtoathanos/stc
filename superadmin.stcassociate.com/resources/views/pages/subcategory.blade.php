...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="javascript:void(0)" class="btn btn-block btn-primary btn-md" data-target="#add-modal" data-toggle="modal">Add Sub Category</a></div>
  ...
  <script>
    $(document).ready(function() {
      ...
      getSubCategory(dataTableAct);      
      
      // get Sub Category function
      function getSubCategory(dataTableAct){
          // DataTable
          $('#example1').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('/master/subcategory/list') }}",
          columns: [
              { data: 'stc_sub_cat_id' },
              { data: 'stc_sub_cat_name' },
              { data: 'stc_sub_cat_status' },
              { data: 'actionData' },
          ],
          columnDefs: [
      ...
      $('body').delegate('.add-category-btn','click', function(){
        ...
        $.ajax({
            ...
            url: "{{ url('/master/subcategory/create') }}",
      ...
      $('body').delegate('.edit-category-btn','click', function(){
        var id = $('#edit_id').val();
        ...
        $.ajax({
            ...
            url: "{{ url('/master/subcategory/edit') }}",
            success: function(response) {
      ...
      $('.delete-category-btn').on('click', function(e){
        ...
        $.ajax({
            ...
            url: "{{ url('/master/subcategory/delete') }}",
            success: function(response) {
              if(response.success==true){
...
<div class="modal fade" id="edit-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default close-btn" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger edit-category-btn">Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<div class="modal fade" id="add-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default close-btn" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger add-category-btn">Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
