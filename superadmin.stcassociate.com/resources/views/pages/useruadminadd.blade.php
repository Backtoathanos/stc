               ...
               <form method="POST" action="" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="contact2" name="contact2" value="{{old('contact2')}}" placeholder="Enter contact 2" required>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="role" name="role">
                        ...
                        <option {{ (old('role')==2) ? 'selected' : '' }} value="2">Report Access for school</option>
                        <option {{ (old('role')==4) ? 'selected' : '' }} value="4">Accountant</option>
                        <option {{ (old('role')==6) ? 'selected' : '' }} value="6">Boss</option>
                        <option {{ (old('role')==9) ? 'selected' : '' }} value="0">Nausher</option>
                    </select>
                  </div>
                  <div class="form-group">
