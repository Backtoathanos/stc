...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="javascript:void(0)" class="btn btn-block btn-primary btn-md" data-target="#add-modal" data-toggle="modal">Add City</a></div>
  ...
  <script>
    $(document).ready(function() {
      ...
      getCity(dataTableAct);      
      
      // get city function
      function getCity(dataTableAct){
          // DataTable
          $('#example1').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('/master/city/list') }}",
          columns: [
              { data: 'stc_city_id' },
              { data: 'stc_city_name' },
              { data: 'stc_city_status' },
              { data: 'actionData' },
          ],
          columnDefs: [
      ...
      $('body').delegate('.add-city-btn','click', function(){
      ...
      $('body').delegate('.edit-city-btn','click', function(){
        var id = $('#edit_id').val();
      ...
      // delete function
      $('.delete-city-btn').on('click', function(e){
        e.preventDefault();
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="button" class="btn btn-danger delete-city-btn">Delete</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<div class="modal fade" id="edit-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default close-btn" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger edit-city-btn">Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<div class="modal fade" id="add-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default close-btn" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger add-city-btn">Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
