               ...
               <form method="POST" action="" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="whatsapp" name="whatsapp" value="{{old('whatsapp')}}" placeholder="Enter whatsapp" required>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="category" name="category">
                        <option {{ (old('category')=="Coordinator") ? 'selected' : '' }} >Coordinator</option>
                        <option {{ (old('category')=="Electrician") ? 'selected' : '' }} >Electrician</option>
                        <option {{ (old('category')=="Operator") ? 'selected' : '' }} >Operator</option>
                        <option {{ (old('category')=="Helper") ? 'selected' : '' }} >Helper</option>
                        <option {{ (old('category')=="Safety Supervisor") ? 'selected' : '' }} >Safety Supervisor</option>
                        <option {{ (old('category')=="Site Incharge") ? 'selected' : '' }} >Site Incharge</option>
                        <option {{ (old('category')=="Supervisor") ? 'selected' : '' }} >Supervisor</option>
                        <option {{ (old('category')=="Technician") ? 'selected' : '' }} >Technician</option>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="manager" name="manager">
                        @foreach($getRecordManger as $value)
                            @if($value->stc_agents_name==old('manager'))
