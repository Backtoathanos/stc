  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="javascript:void(0)" class="btn btn-block btn-primary btn-md" data-target="#add-modal" data-toggle="modal">Add Rack</a></div>
  ...
  <script>
    $(document).ready(function() {
      ...
      function getRack(dataTableAct){
          ...
          processing: true,
          serverSide: true,
          ajax: "{{ url('/master/rack/list') }}",
          columns: [
              { data: 'stc_rack_id' },
              { data: 'stc_rack_name' },
              { data: 'stc_rack_status' },
              { data: 'actionData' },
          ],
          columnDefs: [
      ...
      $('body').delegate('.edit-Rack-btn','click', function(){
        var id = $('#edit_id').val();
      ...
      // delete function
      $('.delete-Rack-btn').on('click', function(e){
        e.preventDefault();
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      <div class="modal-header">
        <h4 class="modal-title">Delete Rack</h4>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="button" class="btn btn-danger delete-Rack-btn">Delete</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<div class="modal fade" id="edit-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default close-btn" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger edit-Rack-btn">Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
