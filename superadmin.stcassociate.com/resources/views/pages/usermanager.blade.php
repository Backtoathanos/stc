  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="{{ url('/users/managerusers/create') }}" class="btn btn-block btn-primary btn-md">Create Manager User</a></div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                              @if($value->stc_agents_role == 1)
                                Manager
                              @elseif($value->stc_agents_role == 2)
                                Procurement
                              @elseif($value->stc_agents_role == 3)
                                SDL
                              @endif
                            </td>
                            <td class="text-center">
