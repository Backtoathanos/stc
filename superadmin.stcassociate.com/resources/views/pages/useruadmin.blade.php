  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="{{ url('/users/uadminusers/create') }}" class="btn btn-block btn-primary btn-md">Create Admin User</a></div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              @if($value->stc_user_phone==$value->stc_user_phone_again)
                                {{$value->stc_user_phone}}
                              @else 
                                {{$value->stc_user_phone}} / {{$value->stc_user_phone_again}}
                              @endif 
                            </td>
                            ...
                            <td class="text-center">
                              @if($value->stc_user_role == 2)
                                Report Access for school
                              @elseif($value->stc_user_role == 1)
                                User
                              @elseif($value->stc_user_role == 9)
                                Nausher
                              @elseif($value->stc_user_role == 6)
                                Boss
                              @else
                                Accountant
                              @endif
                            ...
                            <td class="text-center">
                                <a href="{{url('/users/uadminusers/delete/'.$value->stc_user_id)}}" class="btn btn-danger btn-sm" ><i class='fas fa-trash'></i></a>
                                <a href="{{url('/users/uadminusers/edit/'.$value->stc_user_id)}}" class="btn btn-danger btn-sm" ><i class='fas fa-edit'></i></a>
                                <?php     

                                  $server = $_SERVER['SERVER_NAME']=="localhost" ? "http://localhost/stc" : "https://stcassociate.com";
                                  $user_id = $value->stc_user_id;
                                  $user_type = "uadmin";
