...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">          
        <div class="col-lg-12 col-12"><a href="javascript:void(0)" class="btn btn-block btn-primary btn-md" data-target="#add-modal" data-toggle="modal">Add Brand</a></div>
  ...
  <script>
    $(document).ready(function() {
      ...
      getBrand(dataTableAct);      
      
      // get Brand function
      function getBrand(dataTableAct){
          // DataTable
          $('#example1').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('/master/brand/list') }}",
          columns: [
              { data: 'stc_brand_id' },
              { data: 'stc_brand_title' },
              { data: 'stc_brand_status' },
              { data: 'actionData' },
          ],
          columnDefs: [
      ...
      $('body').delegate('.add-brand-btn','click', function(){
      ...
      $('body').delegate('.edit-brand-btn','click', function(){
        var id = $('#edit_id').val();
      ...
      // delete function
      $('.delete-brand-btn').on('click', function(e){
        e.preventDefault();
...
<div class="modal fade" id="edit-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default close-btn" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger edit-brand-btn">Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<div class="modal fade" id="add-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default close-btn" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-danger add-brand-btn">Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
