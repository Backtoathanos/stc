...
class SiteUsersController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        return $this->modalSuccess($request, url('/users'), 'Site user created successfully!');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return $this->modalSuccess($request, url('/users'), 'Site user updated successfully!');
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return $this->modalSuccess($request, url('/users'), 'Site user deleted successfully!');
    }
}
