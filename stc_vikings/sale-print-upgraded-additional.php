...
if(isset($_GET['aiid'])){
    ...
    $checkpurchaseorder=mysqli_query($con, "
      ...
      WHERE `stc_sale_product_additional_bill_id`='".$_GET['aiid']."'
      AND `stc_sale_product_bill_no_bill_series`='2' 
    ");
    $get_stc_purchase_product=mysqli_fetch_assoc($checkpurchaseorder);
    $get_purchase_product_date=$get_stc_purchase_product['stc_sale_product_additional_bill_date'];
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <div class="row">
                <div class="col-lg-12 billshowvalue">
                  ...
                  <h6>
                    Invoice No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b>STCA/<?php echo substr("0000{$get_stc_purchase_product['stc_sale_product_additional_bill_no']}", -5).'/'.$yearchangevalue;?></b>
                  </h6>
                  <h6>
              ...
              <div class="pre-cond-plus-total-taxb">                
                <table border="0" cellspacing="0" cellpadding="0" id="amount-row-calc">
                  ...
                  $tcssql=mysqli_query($con, "
                    ...
                    AND `stc_sale_product_bill_no_bill_series`='2'
                    ORDER BY `stc_sale_product_additional_bill_id` ASC
                  ");
                  ...
                  foreach ($tcssql as $tcsvalue) {
                    ...
                    if($checkval>=100000000){
                      ...
                      $checkarr[]= array($tcsvalue["stc_sale_product_additional_bill_id"]);
                    }
                    $tcskeeper=0;
                  }
                  $tcsvalue=0;
                  if(in_array($_GET['aiid'], $checkarr)){ 
                    $tcsvalue=0; 
                  }else{
