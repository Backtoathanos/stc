                    ...
                    if($get_stc_purchase_product['stc_sale_product_dc_keys']=="directchallaned"){
                      ...
                      foreach ($_SESSION["stc_print_prevew"] as $key => $value2) {
                        ...
                        if($value2['product_cat']=='OTHERS'){
                          ...
                          $mtype=$value2['product_cat'];
                        }
                        $pd_name=$mtype.' '.nl2br($value2['product_name']).' '.$brand;
                        $pd_len=strlen($pd_name);
                        if($pd_len>50){
                            // $val=$pd_len - $val;
                            $pd_name=substr($pd_name, 0, 50);
                            $pd_name=$pd_name.'...';
                        }
                        ...
                        <tr>
                          ...
                          <td class="text-left"><h6><?php echo $pd_name;?></h6></td>
    ...
    <script>
      $(document).ready(function(){
        ...
        if(height>20){
          ...
          var html = 
          '<tr><td colspan="9">Continue</td></tr><tr style="height: 280px;"><td colspan="9"></td></tr><tr><th>#</th><th width="30%" class="text-left">ITEMS</th><th class="text-right">HSN CODE</th><th class="text-right">UNIT</th><th class="text-right">QTY</th><th class="text-right">RATE</th><th class="text-right">AMOUNT</th><th class="text-right">GST</th><th class="text-right">TOTAL</th></tr>';
            
          $('table > tbody > tr').eq(20).after(html);
          $('table > tbody > tr').eq(50).after(html);
        }
      });
    </script>
  </body>
