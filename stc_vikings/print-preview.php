...
if(isset($_GET['pid'])){
    ...
    $checkpurchaseorder=mysqli_query($con, "
      ...
      LEFT JOIN `stc_user`
      ON `stc_user_id`=`stc_purchase_product_created_by`
      WHERE `stc_purchase_product_id`='".$_GET['pid']."'
    ");
    $get_stc_purchase_product=mysqli_fetch_assoc($checkpurchaseorder);
    $get_purchase_product_date=$get_stc_purchase_product['stc_purchase_product_order_date'];
    $get_purchase_product_merchant_name=$get_stc_purchase_product['stc_merchant_name'];
    $get_purchase_product_notes=$get_stc_purchase_product['stc_purchase_product_notes'];
...
<html lang="en">
  <head>
    ...
    <title>Purchase Order - STC-<?php echo $str;?></title>
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="text-right hidden-print">
      ...
      <a href="purchaseorderfpdf.php?po_id=<?php 
        echo $num.'&pdate='.date('d-m-Y',strtotime($get_purchase_product_date)).'&for='.$get_stc_purchase_product['stc_purchase_product_purchased_for'].'&req='.$get_stc_purchase_product['stc_purchase_product_req_no'].'&suppliername='.$get_stc_purchase_product['stc_merchant_name'].'&supplieraddress='.$get_stc_purchase_product['stc_merchant_address'].'&suppliergstin='.$get_stc_purchase_product['stc_merchant_gstin'].'&supplieremail='.$get_stc_purchase_product['stc_merchant_email'].'&supplierphone='.$get_stc_purchase_product['stc_merchant_phone'].'&suppliercontactperson='.$get_stc_purchase_product['stc_merchant_contact_person'].'&tandc='.$get_stc_purchase_product['stc_purchase_product_notes'].'&createdbyuname='.$get_stc_purchase_product['stc_user_name'].'&createdbyuphone='.$get_stc_purchase_product['stc_user_phone'];?>
      " class="btn btn-info"><i class="fas fa-file-pdf-o"></i> Export as PDF</a>
    </div>
      ...
      <div class="row header">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
          ...
          <div style="float: right;"  >
            <h4 align="right">PO No : STC/<?php echo $str; ?></h4>
            <h4 align="right">PO Date : <?php echo date('d-m-Y',strtotime($get_purchase_product_date)); ?></h4>
            <p style="font-size: 18px;"align="right">REF GTO NO : <?php echo $get_stc_purchase_product['stc_purchase_product_purchased_for']; ?></p>
            <p style="font-size: 18px;position: relative;top: -10px;" align="right">Requisition No : <?php echo $get_stc_purchase_product['stc_purchase_product_req_no']; ?></p>
          </div>
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <div class="col invoice-to">
                ...
                <h2 class="to"><?php echo $get_purchase_product_merchant_name; ?></h2>
                <div class="address">Address : <?php echo $get_stc_purchase_product['stc_merchant_address']; ?></div>
                <div class="address">GSTIN : <?php echo $get_stc_purchase_product['stc_merchant_gstin']; ?></div>
                <div class="email">Email : <a ><?php echo $get_stc_purchase_product['stc_merchant_email']; ?></a></div>
                <div class="email">Phone : <a ><?php echo $get_stc_purchase_product['stc_merchant_phone']; ?></a></div>
              </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <div class="col invoice-to">
                ...
                <h2 class="to">STC ASSOCIATES</h2>
                <div class="address">Address : Rajmahal Apartment, D/304 3rd Floor, Block No 1, Pardih, Jamshedpur, Jharkhand 832110</div>
                <div class="address">GSTIN : 20JCBPS6008G1ZT</div>
                <div class="email">Email : stc111213@gmail.com</div>
                <div class="email">Phone : +91-8986811304</a></div>
              </div>
            </div>
          </div>
          <div class="row" style="margin-top: 10px;">
            <div class="col-xl-12 col-lg-12 col-md-12">
              <div class="">
                <h4><b>Kind Attn: Mr/Miss. <?php echo $get_stc_purchase_product['stc_merchant_contact_person']; ?></b></h4>
              </div>
              <div class="">
                <p>Dear Sir/Madam,<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <!-- table -->
            <div class="col-xl-12 col-lg-12 col-md-12">
              <table border="0" cellspacing="0" cellpadding="0" id="stc-table-count">
                <tbody>
                  <tr>
                      <th>#</th>
                      <th width="40%" class="text-left">ITEMS</th>
                  ...
                  <?php
                    ...
                    $mtype='';
                      $checkpurchaseorderitems=mysqli_query($con, "
                        ...
                        WHERE `stc_purchase_product_items_order_id`='".$_GET['pid']."'
                      ");
                  ...
                  <tr>
                    ...
                    <td class="text-left">
                      <h6>
                        <?php echo 'Supply of '.$mtype.' '.nl2br($row['stc_product_name']).' '.$brand;?>
                      </h6>
                    </td>
                    <td class="unit"><?php echo $row['stc_product_hsncode'];?></td>
                    <td class="qty"><?php echo $row['stc_product_unit'];?></td>
                    <td class="total"><?php echo number_format($row['stc_purchase_product_items_qty'], 2);?></td>
                    <td class="total"><?php echo number_format($row['stc_purchase_product_items_rate'], 2);?></td>
                  ...
                  <?php
                    if($get_stc_purchase_product['stc_merchant_state_id']==16){
                      echo '
                          <tr>
                              <td colspan="3"></td>
                              <td align="right" colspan="3">CGST :</td>
                              <td align="right">'.number_format($totalgst/2, 2).'</td>
                          </tr>
                          <tr>
                              <td colspan="3"></td>
                  ...
                  <tr>
                    <td colspan="5"></td>
                    <td align="right" colspan="1">GRAND TOTAL :</td>
                    <td align="right">
                      <?php 
                        $grandtotal=ceil($totalgst + $total);
            ...
            <div class="col-xl-12 col-lg-6 col-md-12">
              <div class="">
                ...
                <div>
                  <p><?php echo $get_stc_purchase_product['stc_user_name'];?><br>+91-<?php echo $get_stc_purchase_product['stc_user_phone'];?></p>
                </div>
              </div>
            </div>
          </div>
