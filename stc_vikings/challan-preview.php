...
<html lang="en">
  ...
  <body>
    <div class="text-right hidden-print">
      ...
      <a href="challanpdf.php?challan_id=<?php 
        echo $num.
          ...
          '&sitename='.$get_stc_purchase_product['stc_sale_product_sitename'].
        ...
        <div class="container-fluid">            
              ...
              <table border="0" cellspacing="0" cellpadding="0">
                <!-- <thead> -->
                  ...
                  <?php
                    ...
                    $mtype='';
                      $checkpurchaseorderitems=mysqli_query($con, "
                        ...
                        WHERE `stc_sale_product_items_sale_product_id`='".$_GET['pid']."'
                      ");
                  ...
                  <tr>
                    ...
                    <td class="total"><?php echo number_format($row['stc_sale_product_items_product_qty'], 2);?></td>
          ...
          <div class="row footer">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
              ...
              <div class="pre-cond-plus-total-taxb">                
                <div id="signatory-stc">
                  <p>For <span><b>Customer Reciever</b></span></p>
                  <br><br><br> 
                  <p><span align="center">Reciever Signatory</span></p> 
                </div>
              </div>
            </div>
          </div>
