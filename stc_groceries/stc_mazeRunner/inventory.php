                            ...
                            if(empty($_GET['inv_pd_search'])){
                              ...
                              if(mysqli_num_rows($stcelectroinvquery)>0){
                                foreach($stcelectroinvquery as $invrow){
                                  $loki_getfrpuritems=mysqli_query($con, "
                                    ...
                                    WHERE 
                                      `stc_groceries_purchase_items_item_id`='".$invrow["stc_groceries_product_id"]."' 
                                  ");
                                  $pquantity=0;
                                  $prate=0;
                                  $punit='';
                                  foreach($loki_getfrpuritems as $loki_getfrpuritemsrow){
                                    $pquantity+=$loki_getfrpuritemsrow['stc_groceries_purchase_items_qty'];
                                    $punit=$loki_getfrpuritemsrow['stc_groceries_purchase_items_unit'];

                                    $gstamount = ($loki_getfrpuritemsrow['stc_groceries_purchase_items_price'] * $loki_getfrpuritemsrow["stc_groceries_purchase_items_gst"])/100;
                                    $prate=$loki_getfrpuritemsrow['stc_groceries_purchase_items_price'] + $gstamount;
                                  }
                                  ...
                                  $loki_getfrsaleitems=mysqli_query($con, "
                                    ...
                                    WHERE 
                                      `stc_groceries_sale_items_item_id`='".$invrow["stc_groceries_product_id"]."' 
                                  ");
                                  ...
                                  foreach($loki_getfrsaleitems as $loki_getfrsaleitemsrow){
                                    $squantity+=$loki_getfrsaleitemsrow['stc_groceries_sale_items_item_qty'];
                                    $sunit=$loki_getfrsaleitemsrow['stc_groceries_sale_items_item_unit'];
                                  }
                                  ...
                                  echo "
                                    <tr>
                                      ...
                                      <td class='text-center'>".$invrow['stc_groceries_product_id']."</td>
                                      <td class='text-center'>".$invrow['stc_groceries_product_title']."</td>
                              ...
                              $stcelectroinvquery=mysqli_query($con, "
                                ...
                                FROM
                                  `stc_groceries_product`
                                WHERE 
                                  `stc_groceries_product_title` REGEXP '".mysqli_real_escape_string($con, $_GET['inv_pd_search'])."'
                                  OR `stc_groceries_product_details` REGEXP '".mysqli_real_escape_string($con, $_GET['inv_pd_search'])."'
                                ORDER BY
                                ...
                                foreach($stcelectroinvquery as $invrow){
                                  $loki_getfrpuritems=mysqli_query($con, "
                                    ...
                                    FROM 
                                      `stc_groceries_purchase_items` 
                                    WHERE 
                                      `stc_groceries_purchase_items_item_id`='".$invrow["stc_trading_product_id"]."' 
                                  ");
                                  $pquantity=0;
                                  $prate=0;
                                  $punit='';
