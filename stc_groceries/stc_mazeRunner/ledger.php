...
<body class="">
              ...
              <div class="card">
                  ...
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#stc-show-Ledger" data-toggle="tab">
                            <i class="material-icons">visibility</i> Show Ledger
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="tab-pane active" id="stc-show-Ledger">
                      <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mx-auto stc-view">
                          <div class="tm-bg-primary-dark tm-block tm-block-h-auto" >
                            <div class="row">
                              <div class="col-12">
                                <h2 class="tm-block-title d-inline-block">Ledger</h2>
                              </div>
                            </div>
                              ...
                              <div class="col-xl-12 col-lg-12 col-md-12">
                                <form action="" class="stc-silent-challan-form">
                                    <table class="table table-hover table-bordered">
                                      <thead>
                                        <tr>
                                          <th class="text-center" scope="col">By Customer Name</th>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>
                                            <select
                                              name="silentledgercustomername"
                                              class="form-control validate silentledgercustomername"
                                            ><option value="NA">Please Select Customer First</option><?php
                                                ...
                                                $customer_qry=mysqli_query($con, "
                                                  ...
                                                  ORDER BY `stc_groceries_customer_title` DESC
                                                ");
                                                foreach($customer_qry as $customer_row){
                                                  echo '<option value="'.$customer_row['stc_groceries_customer_id'].'">'.$customer_row['stc_groceries_customer_title'].'</option>';
                                                }
                                            ?>
                                            </select>
                                          </td>
                                          <td>
                                            <button type="button" name="challansearch" class="form-control btn btn-primary" id="ledgersearch">Search</button>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                            ...
                            <div class="row stc-view-sale-row" style="width: auto;overflow-x: auto; white-space: nowrap;">
                              <div class="col-xl-12 col-lg-12 col-md-12">
                                <form action="" class="stc-ledger-result-show">
                                    <table class="table table-hover table-bordered ">
                                      <thead>
                                        <tr>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="text-center" colspan="6">Search Customer Ledger</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                </form>
  ...
  <script>
    $(document).ready(function(){
      $('body').delegate('#ledgersearch', 'click', function(e){
        e.preventDefault();
        var cust_id=$('.silentledgercustomername').val();
        $.ajax({
          url     : "../vanaheim/ledger_call.php",
          method  : "POST",
          data    : {
            stc_call_ledger:1,
            cust_id:cust_id
          },
          success : function(response_ledger){
            $('.stc-ledger-result-show').html(response_ledger);
          } 
        });
      });
    });
