                        ...
                        <ul class="nav nav-tabs" data-tabs="tabs">
                          <li class="nav-item">
                            <a class="nav-link active" href="#stc-create-customer" data-toggle="tab">
                              <i class="material-icons">add_circle</i> Create Merchant
                              <div class="ripple-container"></div>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#stc-show-customer" data-toggle="tab">
                              <i class="material-icons">visibility</i> Show Merchant
                              <div class="ripple-container"></div>
                            </a>
                          </li>
                        </ul>
                  ...
                  <div class="card-body">
                    <div class="tab-content">
                      <div class="tab-pane active" id="stc-create-customer">
                        <div class="row">
                          <div class="col-12">
                            <h2 class="tm-block-title d-inline-block">Create Merchant</h2>
                          </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                  <div class="mb-3">
                                    ...
                                    <input
                                      ...
                                      placeholder="Enter Merchant Name. eg:- Adam (company Adam)"
                                    />
                                  </div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                  <div class="mb-3">
                                    ...
                                    <input
                                      ...
                                      placeholder="Enter Merchant's 10-Digit Contact Number"
                                      maxlength="10"
                                    />
                                  </div>
                                </div>
                        ...
                        <div class="row">
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mx-auto stc-view">
                            <div class="tm-bg-primary-dark tm-block tm-block-h-auto" >
                              <div class="row">
                                <div class="col-12">
                                  <h2 class="tm-block-title d-inline-block">Show Merchant</h2>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                  <form action="" class="stc-silent-challan-form">
                                      <table class="table table-hover table-bordered table-responsive">
                                        <thead>
                                          <tr>
                                            <th scope="col">By Merchant Name, Merchant Contact Number/ Address/ Type</th>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                  <form action="" class="stc-view-silent-customer-row-fetch">
                                      <table class="table table-hover table-bordered table-responsive">
                                        <thead>
                                          <tr>
                                            <th class="text-center" scope="col" width="20%"><b>Merchant Name</b></th>
                                            <th class="text-center" scope="col"><b>Merchant Address</b></th>
                                            <th class="text-center" scope="col"><b>Merchant City/<br> Merchant State/<br> Merchant Pin Code</b></th>
                                            <th class="text-center" scope="col"><b>Merchant Contact</b></th>
                                            <th class="text-center" scope="col"><b>Merchant Type</b></th>
                                        ...
                                        <tbody class="stc-silent-show-customer">
                                          <tr><td colspan="7" class="text-center">Search Merchant Here</td></tr>
                                        </tbody>
                                      </table>
                                  </form>
                                </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      $('body').delegate('#stccustomersavehit', 'click', function(e){
        ...
        $.ajax({  
          url       : "../vanaheim/merchant-done.php",
          method    : "POST",  
          data      : {
          ...
          success   : function(data){
           ...
           if(response=="Merchant Added Successfully!!!"){
            alert(data);
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mx-auto">
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                ...
                <input type="text" class="form-control stc-tra-edit-cust-title" placeholder="Enter Merchant Name" disabled>
              </div>
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <h5>
                  Merchant Address
                </h5>
                <textarea class="form-control stc-tra-edit-cust-address" placeholder="Enter Merchant Address"></textarea>
              </div>
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <h5>
