                                  ...
                                  <div class="mb-3">
                                    ...
                                    <?php
                                      ...
                                      $getmerchantqry=mysqli_query($con, "
                                        ...
                                        FROM `stc_groceries_merchant` 
                                        ORDER BY `stc_groceries_merchant_title` ASC
                                      ");
                                      if(mysqli_num_rows($getmerchantqry)>0){
                                        ...
                                        foreach($getmerchantqry as $merchantdetrow){
                                          echo '<option value="'.$merchantdetrow['stc_groceries_merchant_id'].'">'.$merchantdetrow['stc_groceries_merchant_title'].'</option>';
                                        }
                                      }else{
                    ...
                    <td class="text-center">
                      ...
                      <?php include_once("../../MCU/db.php");
                        ...
                        foreach($odin_callpdqry as $odin_callpdrow){
                            echo '<option value="'.$odin_callpdrow['stc_groceries_product_id'].'" selected>'.$odin_callpdrow['stc_groceries_product_title'].'</option>';
                        }
                      ?>
                      </select>
                    </td>
