  ...
  <body class="">
                ...
                <div class="card">
                    ...
                    <div class="nav-tabs-navigation">
                      <div class="nav-tabs-wrapper">
                        ...
                        <ul class="nav nav-tabs" data-tabs="tabs">
                          <li class="nav-item">
                            <a class="nav-link active" href="#stc-show-Request" data-toggle="tab">
                              <i class="material-icons">visibility</i> Request Raised
                  ...
                  <div class="card-body">
                    <div class="tab-content">
                      <div class="tab-pane active" id="stc-show-Request">
                        <div class="row">
    ...
    <script>
      $(document).ready(function(){
        ...
        // call request raised
        stc_call_request_raised();
        function stc_call_request_raised(){
          $.ajax({  
            url       : "../vanaheim/request-raised.php",
            method    : "POST",  
            data      : {
              stc_call_request_raised : 1
            },
            // dataType: `JSON`,
        ...
        // change status
        $('body').delegate('.stc-e-request-action', 'click', function(e){
          e.preventDefault();
