...
if(isset($_GET['pdcid'])){
    ...
    $checkpurchaseorder=mysqli_query($con, "
      ...
      WHERE `stc_sale_product_silent_challan_id`='".$_GET['pdcid']."'
    ");
    $get_stc_purchase_product=mysqli_fetch_assoc($checkpurchaseorder);
    $get_purchase_product_date=$get_stc_purchase_product['stc_sale_product_silent_challan_date'];
    $get_purchase_product_merchant_name=$get_stc_purchase_product['stc_sale_product_silent_challan_customer_name'];
    $get_purchase_product_notes=$get_stc_purchase_product['stc_sale_product_silent_challan_notes'];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Silent Challan - STC-DC-<?php echo $str;?></title>
    <link
      rel="stylesheet"
    ...
    <div class="container-fluid tm-mt-big tm-mb-big invoice">
      ...
      <div class="row med">
        <div class="container-fluid">            
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <div class="row">
                <div class="col-lg-12 billshowvalue">
                  ...
                  <h6>
                    Customer PO No &nbsp;&nbsp;: <b>NA</b>
                  </h6>
                  <h6>
                    Customer PO Date &nbsp;&nbsp;: <b>NA</b>
                  </h6>
                  <h6>
                    Reference &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
                    <b>
          ...
          <?php 
          if($get_stc_purchase_product['stc_sale_product_silent_challan_status']=='returned'){
            echo '
              ...
              <table border="0" cellspacing="0" cellpadding="0">
                <!-- <thead> -->
                  ...
                  <?php
                    ...
                    $mtype='';
                      $checkpurchaseorderitems=mysqli_query($con, "
                        ...
                        WHERE `stc_sale_product_silent_challan_items_order_id`='".$_GET['pdcid']."'
                      ");
                      while ($row=mysqli_fetch_assoc($checkpurchaseorderitems)) {
                        $sl++;
                        $amount=$row['stc_sale_product_silent_challan_items_product_qty'] * $row['stc_sale_product_silent_challan_items_product_sale_rate'];
                  ...
                  <tr>
                    ...
                    <td class="total"><?php echo number_format($row['stc_sale_product_silent_challan_items_product_qty'], 2);?></td>
