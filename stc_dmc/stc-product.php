        ...
        $(document).ready(function(){
            ...
            $(window).scroll(function(){                
                ...
                if( position == bottom ){
                    ...
                    var row = Number($('#stc_pro_curr_row').val());
                    var allcount = Number($('#stc_pro_all_row').val());
                    var rowperpage = 3;
                    row = row + rowperpage;

                    if(row <= allcount){
                        $('#stc_pro_curr_row').val(row);
                        $.ajax({
                            ...
                            success: function(response){
                                ...
                                $(".called-product-page:last").after(response).show().fadeIn("slow");
                            }
                        });
                    }
                }
