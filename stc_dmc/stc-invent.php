                                ...
                                <!-- <div class="card mb-3 widget-content"> -->
                                    <?php
                                        ...
                                        $qry=mysqli_query($con, "
                                            ...
                                            WHERE `stc_own_agent_inventory_pd_qty`>0 AND 
                                            `stc_own_agent_inventory_agent_id`='".$_SESSION['stc_agent_id']."'
                                        ");
                                        if(mysqli_num_rows($qry)>0){
                                                        ...
                                                        <div class="box-up">
                                                            ...
                                                            <div class="img-info">
                                                                <div class="info-inner">
                                                                    ...
                                                                    <span class="p-company">'.number_format($row["stc_own_agent_inventory_pd_qty"], 2).'</span>
                                                                </div>
                                                                <div class="a-size">
                                                                </div>
                                                            </div>
                                            ...
                                            echo "Hey pal you dont have any product you need to buy something!!!:)"."
                                            <a href='stc-product.php'>lets order something</a>
                                            ";
                                        }
                                    ?>
                                <!-- </div> -->
