...
<html lang="en">
<head>
	<title>Products | Products :: STC Associate</title>
	<!-- for-mobile-apps -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="STC Associate products name" />
					...
					<ul class="nav navbar-nav">
								...
								<div class="row">
									...
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											...
											<li><a href="products.php?product=TMT Bar">TMT Bars</a></li>
										</ul>
									</div>
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
						...
						<li class="w3pages"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Franchise <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="stc-electronics.php">STC Electronics</a></li>
								<li><a href="stc-tradings.php">STC Trading</a></li>     
							</ul>
						</li>
			...
			if(isset($_GET['product']) && !empty($_GET['product'])){
				...
				if($checkrow>0){
					foreach($stconpdqry as $getproductrow){
						$subcat='';
						$pdname=substr($getproductrow['stc_product_name'], 0, 15).'...';
						if($getproductrow['stc_sub_cat_name']=="OTHERS"){
							$subcat='';
						}else{
							$subcat=$getproductrow['stc_sub_cat_name'];
						}
						echo '
									...
									<div class="agile_ecommerce_tab_left mobiles_grid">
										<div class="hs-wrapper hs-wrapper2">
											...
											<div class="w3_hs_bottom w3_hs_bottom_sub1">
												<ul>
													<li>
														<a href="#" data-toggle="modal" data-target="#myModal'.$getproductrow['stc_product_id'].'"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
													</li>
												</ul>
											</div>
										</div>
										<h5><a href="singlepeices.php?productname='.$getproductrow['stc_product_name'].'&&pdid='.$getproductrow['stc_product_id'].'"">'.$subcat.' '.$pdname.'</a></h5> 
										<div class="simpleCart_shelfItem">
										</div> 
									</div>
								</div>
									<div class="modal video-modal fade" id="myModal'.$getproductrow['stc_product_id'].'" tabindex="-1" role="dialog" aria-labelledby="myModal'.$getproductrow['stc_product_id'].'">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
												...
												<section>
													<div class="modal-body">
														...
														<div class="col-md-7 modal_body_right">
															...
															<p>'.$subcat.' '.$getproductrow['stc_product_name'].'</p>
															<div class="">
																<form action="#" method="post">  
																	<a href="#" id="'.$getproductrow['stc_product_id'].'" class="w3ls-cart">Get for qoute</a>
																</form>
															</div> 
														</div>
														<div class="clearfix"> </div>
