...
$(document).ready(function() {
    var table = $('#designationsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "/stc/stc_payroll/master/designations/list",
            type: 'GET'
        },
        columns: [
            { data: 'id', name: 'id' },
    ...
    $(document).on('click', '.view-btn', function() {
        var id = $(this).data('id');
        $.ajax({
            url: "/stc/stc_payroll/master/designations/show/" + id,
            type: 'GET',
    ...
    $('#editDesignationForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "/stc/stc_payroll/master/designations/" + id,
            type: 'POST',
    ...
    $('#addDesignationForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "/stc/stc_payroll/master/designations",
            type: 'POST',
            data: formData,
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
