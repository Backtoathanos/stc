   ...
   <?php include "header.php";?>
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="#" class="active" value="">Direct Challan</a></li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <label class="btn btn-default text-uppercase">
                  <a href="dc-payments.php" class="btn btn-success btn-block text-uppercase">
                    <b>+</b> Create DC Invoice Payments
                  </a>
                </label>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
      ...
      <div class="row animated zoomInUp">
        ...
        <div style="display: none;" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mx-auto stc-add">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Direct Challan</h2> <a id="stc_uppp" href="#"><i class="fas fa-arrow-up"></i></a>
              </div>
            </div>
            <div class="row stc-direct-challan-row">
              ...
              <div class="col-xl-12 col-md-12 col-sm-12 thishypo">
                <div class="row stc-call-view-direct-challan-product-row">
                </div>
              </div>
              <!-- line item table -->
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mx-auto stc-view">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto" >
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            <p><a href="#" id="dirchallandatefilt">
                          ...
                          <td>
                            <a class="btn btn-secondary stcsearchdchit">Search <i class="fa fa-search"></i></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
            ...
            <div class="row stc-view-sale-row" style="width: auto;overflow-x: auto; white-space: nowrap;">
              <div class="col-xl-12 col-lg-12 col-md-12">
                <form action="" class="stc-view-Direct-Challan-form">
                    <table class="table table-hover ">
                      <tr><td>Loading....</td></tr>
                    </table>
                </form>
    ...
    <script>
      $(document).ready(function(){
        ...
        // load_data();
        function load_data(query, directchallanbegdate, directchallanenddate) {
          $.ajax({
        ...
        $('#challansearch').click(function(){
          ...
          load_data(query, directchallanbegdate, directchallanenddate);
        });
        ...
        function load_challan_items(query) {
          $.ajax({
            ...
            success:function(data){
              // console.log(data);
              // $('#total_records').text(data.length);
              $('.stc-call-view-direct-challan-product-row').html(data);
            }
          });
        }
