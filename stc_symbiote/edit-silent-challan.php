  ...
  <body>
   <?php include "header.php";?>
    ...
    <div class="container-fluid tm-mt-big tm-mb-big">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="silent-challan.php" class="active" value="">Silent Challan</a></li>
                    <li class="breadcrumb-item active"><a href="#" class="active" value="">Edit Silent Challan</a></li>
                  </ol>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <?php
          if(isset($_GET['ededcid'])){
            include "../MCU/db.php";
            $challanquery=mysqli_query($con, "
              SELECT * FROM `stc_sale_product_silent_challan` 
              WHERE `stc_sale_product_silent_challan_id`='".$_GET['edcid']."'
            ");
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mx-auto stc-add">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Sale Point</h2>
              </div>
            </div>
                  ...
                  <tbody>
                    <?php 
                      ...
                      $lokigetitems=mysqli_query($con, "
                        ...
                        WHERE `stc_sale_product_items_sale_product_id`='".$_GET['edcid']."'
                      ");
                      $dataqty='';
    ...
    <script>
      $(document).ready(function(){
        $('.upward').on('click', function(e){
          e.preventDefault();
            $('.downward').toggle(500);
            $('.stc-call-view-sale-product-row').fadeOut(500);
            $('.upward').fadeOut(500);
        });
        ...
        $('.downward').on('click', function(e){
          e.preventDefault();
            $('.upward').toggle(500);
            $('.stc-call-view-sale-product-row').toggle(500);
            $('.downward').fadeOut(500);
        });
        
        // challan input
        function load_edit_challan_items(query) {
          $.ajax({
