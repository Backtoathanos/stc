              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="agent-order.php" value="">Agent Order</a></li>
                    <li class="breadcrumb-item active"><a href="#" class="active" value="">Requisition</a></li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mx-auto stc-req-view">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="overflow-x: auto; white-space: nowrap;">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                  <form action="" class="stc-view-product-form">
                      <table class="table table-hover ">
                        <thead>
                          <tr>
                            <th scope="col" width="100%">By Order Number/ Customer/ Agents/ Status</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <button type="button" name="search" class="btn btn-primary" id="ag-req-list-search">Search</button>
                            </td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <div class="row stc-view-purchase-row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                  <form action="" class="stc-view-ag-requisition-show-form">
        ...
        function stc_call_ag_order(url_param){
          $.ajax({
            ...
            success   : function(data){
              // console.log(data);
              $('.stc-view-ag-requisition-show-form').html(data);
            }
          });
        }

        $('body').delegate('#ag-req-list-search', 'click', function(e){
          e.preventDefault();
          var listcontains=$('#ag-req-list-tags').val();
          $.ajax({
            url     : "asgard/mjolnirgetorder.php",
            method    : "post",
            data    : {
              searchcallrequisitionlist:1,
              url_param:url_param,
