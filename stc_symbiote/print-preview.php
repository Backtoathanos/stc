    ...
    <div class="container-fluid tm-mt-big tm-mb-big invoice">
      <div class="row header">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
          <div style="height: 50px;"><img style="height: 50px;" src="img/stc-header.png"></div>
          <p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
          ...
          <div style="float: right;"  >
            ...
            <h4 align="right">Reference GTO No : <?php echo $get_stc_purchase_product['stc_purchase_product_purchased_for']; ?></h4>
          </div>
        </div>
              ...
              <table border="0" cellspacing="0" cellpadding="0">
                <!-- <thead> -->
                  ...
                  <tr>
                    ...
                    <td class="text-left">
                      <h6>
                        <?php echo $mtype.' '.nl2br($row['stc_product_name']).' '.$brand;?>
                      </h6>
                    </td>
