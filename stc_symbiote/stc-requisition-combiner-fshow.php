      ...
      <div class="row header">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
          ...
          <div style="float: right;"  >
            <h4 align="right">PR No : STC/<?php echo $str; ?></h4>
            <h4 align="right">PR Date : <?php echo date('d-m-Y',strtotime($get_purchase_product_date)); ?></h4>
          </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
              <table border="0" cellspacing="0" cellpadding="0">
                <!-- <thead> -->
                  <tr>
                      <th>#</th>
                      <th width="70%" class="text-left">ITEMS DESCRIPTIONS</th>
                  ...
                  <?php
                      ...
                      $currentrequisition=mysqli_query($con, "
                        ...
                        WHERE `stc_requisition_combiner_id`='".$_GET['requi_id']."'
                      ");
                      foreach($currentrequisition as $requisitionrow){
                        $getrequisitionitemqry=mysqli_query($con, "
                          SELECT 
                          ...
                          WHERE `stc_cust_super_requisition_list_items_req_id`='".$requisitionrow['stc_cust_super_requisition_list_id']."'
                        ");
                        while ($row=mysqli_fetch_assoc($getrequisitionitemqry)) {
                          $sl++;
                          ?>
                          <tr>
