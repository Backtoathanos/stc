                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" class="mb-2 form-control" id="name" value="<?php echo $fetch_data['stc_agents_name']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="position-relative form-group">
                                                            <label for="contact" class=""><b>Contact</b></label>
                                                            <input type="text" class="mb-2 form-control" id="contact" value="<?php echo $fetch_data['stc_agents_contact']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="position-relative form-group">
                                                            <label for="email" class=""><b>Email</b></label>
                                                            <input type="email" class="mb-2 form-control" id="email" value="<?php echo $fetch_data['stc_agents_email']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">                  
                                                        <div class="position-relative form-group">
                                                            <label for="address" class=""><b>Address</b></label>
                                                            <input type="text" class="mb-2 form-control" id="address" value="<?php echo $fetch_data['stc_agents_address']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-4">
                                                        <div class="position-relative form-group">
                                                            <label for="userid" class=""><b>User Id</b></label>
                                                            <input type="text" class="mb-2 form-control" id="userid" value="<?php echo $fetch_data['stc_agents_userid']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-4">
                                                        <div class="position-relative form-group">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <div class="position-relative form-group">
                                                            <input type="hidden" class="stc-account-id" value="<?php echo $fetch_data['stc_agents_id']; ?>">
